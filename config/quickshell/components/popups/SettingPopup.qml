...
UiPopup {
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            implicitHeight: 48
            radius: 8
            color: recMouse.containsMouse ? ThemeColors.bgButtonHover : ThemeColors.bgBase
            ...
            MouseArea {
                ...
                onClicked: {
                    root.toggle();
                    Hyprland.dispatch("hl.dsp.exec_cmd(\"~/.local/bin/hs-video-capture\")");
                }
            }
        ...
        Rectangle {
            ...
            implicitHeight: 48
            radius: 8
            color: shotMouse.containsMouse ? ThemeColors.bgButtonHover : ThemeColors.bgBase
            border.color: ThemeColors.borderBase
            border.width: 1
            ...
            MouseArea {
                ...
                onClicked: {
                    root.toggle();
                    Hyprland.dispatch("hl.dsp.exec_cmd(\"~/.local/bin/hs-screenshot save\")");
                }
            }
